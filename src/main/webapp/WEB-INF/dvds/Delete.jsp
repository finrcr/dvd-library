...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
	...
	<tr>
		<td colspan="2">
		<form:form id="DeleteForm" name="deleteDvd" action="/dvd-library/dvds/delete" method="POST" modelAttribute="dvdForm">
			<input type="hidden" name="buttonState" value='DeleteDvd'/>
			
			<br/><br/><strong>&nbsp;&nbsp;&nbsp;&nbsp;Delete/Remove an Existing DVD from the Library</strong><br/><br/><br/>
			...
			<input type="submit" value="Delete Dvd from Library" />
